...
| `RawPacket` and friends (`TextMessagePacket`, `TraceroutePacket`, `PositionPacket`, `NodeInfoPacket`, `TelemetryPacket`, `RoutingAppPacket`, `EncryptedPacket`) | The captured wire-level packet data. See [packet-ingestion/](packet-ingestion/) and [packet-ingestion/PACKET_FIELDS.md](packet-ingestion/PACKET_FIELDS.md).                                                     |
