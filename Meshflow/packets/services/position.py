...
class PositionPacketService(BasePacketService):
    ...
    def _process_packet(self) -> None:
        ...
        Position.objects.create(
            ...
            meshtastic_location_source=self.packet.meshtastic_location_source or LocationSource.UNSET,
            meshtastic_precision_bits=self.packet.meshtastic_precision_bits,
