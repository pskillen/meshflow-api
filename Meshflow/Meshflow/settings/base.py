...
DX_MONITORING_TRACEROUTE_HOP_DISTANCE_KM = _dx_env_float("DX_MONITORING_TRACEROUTE_HOP_DISTANCE_KM", 150.0)

# DX exploration: queue DX_WATCH (and link NEW_NODE_BASELINE) for active events (#221).
DX_MONITORING_EXPLORATION_ENABLED = _dx_env_bool("DX_MONITORING_EXPLORATION_ENABLED", False)
DX_MONITORING_EXPLORATION_MAX_SOURCES_PER_EVENT = _dx_env_int("DX_MONITORING_EXPLORATION_MAX_SOURCES_PER_EVENT", 1)
DX_MONITORING_EXPLORATION_EVENT_COOLDOWN_MINUTES = _dx_env_int("DX_MONITORING_EXPLORATION_EVENT_COOLDOWN_MINUTES", 45)
DX_MONITORING_EXPLORATION_TARGET_COOLDOWN_MINUTES = _dx_env_int("DX_MONITORING_EXPLORATION_TARGET_COOLDOWN_MINUTES", 30)
DX_MONITORING_EXPLORATION_SOURCE_COOLDOWN_MINUTES = _dx_env_int("DX_MONITORING_EXPLORATION_SOURCE_COOLDOWN_MINUTES", 30)
DX_MONITORING_EXPLORATION_BASELINE_RECENCY_MINUTES = _dx_env_int(
    "DX_MONITORING_EXPLORATION_BASELINE_RECENCY_MINUTES", 120
)
DX_MONITORING_EXPLORATION_BASELINE_FAILURE_COOLDOWN_MINUTES = _dx_env_int(
    "DX_MONITORING_EXPLORATION_BASELINE_FAILURE_COOLDOWN_MINUTES", 60
)
