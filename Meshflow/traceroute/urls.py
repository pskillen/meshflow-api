...
urlpatterns = [
    ...
    path("feeder-reach/", views.feeder_reach, name="traceroute-feeder-reach"),
    path("constellation-coverage/", views.constellation_coverage, name="traceroute-constellation-coverage"),
