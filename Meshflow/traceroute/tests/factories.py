"""Shared ``AutoTraceRoute`` construction for tests (pytest fixtures wrap this)."""
...
def make_auto_traceroute(
    create_managed_node: Callable[[], Any],
    create_observed_node: Callable[[], Any],
